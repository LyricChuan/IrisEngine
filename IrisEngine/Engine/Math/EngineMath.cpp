...
namespace EngineMath
{
    ...
    {
        FCubeMapAxialRangeR()
            :PositiveX(45.f, 135.f, 45.f, -45.f)//phi 属于 0到45度  0到-45度
            ,NegativeX(45.f, 135.f, 135.f, -135.f)//phi 属于 135到180度 -135到-180度
            ,PositiveY(0.f,  45.f,360.f,-360.f)//theta 属于 0到45度
            ,NegativeY(135.f, 180.f, 360.f, -360.f)//theta 属于 135到180度
