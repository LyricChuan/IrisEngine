...
void CStaticMeshComponent::DrawQuadrilateral(FMeshRenderingData& MeshData,const fvector_4id& InDrawPoint, bool bReversal)
{
	if (!bReversal)
	{
		//三角形1
...
fvector_4id CStaticMeshComponent::GetQuadrilateralDrawPointTypeA(int InRowsand, int InColumns, int GroupLayer, int Offset)
{
